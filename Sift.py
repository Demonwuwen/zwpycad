def sift(result):
    ...
    # 寻找并处理“单板报表”文件
    folder_path = "D:/CODE/GUI/File/"
    single_board_files = [filename for filename in os.listdir(folder_path) if "单板报表" in filename]

    for filename in single_board_files:
    ...
    # 寻找并处理“网元报表”文件
    ne_report_files = [filename for filename in os.listdir(folder_path) if "网元报表" in filename]
