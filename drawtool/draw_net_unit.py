...
def draw_link_eclipse(msp, point, net_name):
    ...
    msp.add_text(net_name, dxfattribs={'style': 'OpenSans', 'height': 3, 'width': 0.7, 'color': 5}).set_placement((220+point[0], 180+ point[1]), align=TextEntityAlignment.MIDDLE_CENTER)
